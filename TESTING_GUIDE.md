...
curl https://operationshub.preview.emergentagent.com/

# Test login endpoint
curl -X POST https://operationshub.preview.emergentagent.com/api/login \
  -H "Content-Type: application/json" \
  -d '{"username":"chairman_board","password":"password123"}'

# Test equipment API (requires auth)
curl https://operationshub.preview.emergentagent.com/api/equipment
```
