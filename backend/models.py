...
ROLE_PERMISSIONS = {
    UserRole.SUPERADMIN: {
        ...
        "vendor_bills": ["create", "read", "update", "delete", "approve"],
        "vendor_payments": ["create", "read", "update", "delete"],
        "customers": ["create", "read", "update", "delete"],
        "ar_invoices": ["create", "read", "update", "delete"],
        "customer_payments": ["create", "read", "update", "delete"],
        "fixed_assets": ["create", "read", "update", "delete", "depreciate"],
        "tax_configuration": ["create", "read", "update", "delete"],
        ...
        "stock_adjustments": ["create", "read", "update", "delete", "approve"],
        "dashboard": ["read"],
        "reports": ["read", "export"],
    },
    UserRole.OWNER: {
    ...
    UserRole.MANAGER: {
        ...
        "vendors": ["read"],
        "vendor_bills": ["read", "approve"],
        "vendor_payments": ["read", "approve"],
        "customers": ["read"],
        "ar_invoices": ["read"],
        "customer_payments": ["read"],
        "fixed_assets": ["read"],
        "tax_configuration": ["read"],
        "currencies": ["read"],
        "exchange_rates": ["read"],
        "financial_reports": ["read", "generate", "export"],
    ...
    UserRole.ACCOUNTANT: {
        ...
        "journal_entries": ["create", "read", "update", "delete", "post", "reverse"],
        "vendors": ["create", "read", "update", "delete"],
        "vendor_bills": ["create", "read", "update", "delete"],
        "vendor_payments": ["create", "read", "update", "delete"],
        "customers": ["create", "read", "update", "delete"],
        "ar_invoices": ["create", "read", "update", "delete"],
        "customer_payments": ["create", "read", "update", "delete"],
